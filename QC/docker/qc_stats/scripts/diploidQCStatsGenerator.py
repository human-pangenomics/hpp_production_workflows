...
def main():
    ...
    parser.add_argument('--dipLenStats')
    parser.add_argument('--dipErrorStats')
    parser.add_argument('--dipQVStats')
    ...
    with open(args.output, 'w') as outFile:
        outFile.write("************* {} *************\n\n".format(args.childID))
        outFile.write("\n-Diploid\n")
    printLengthStats(args.dipLenStats, args.output)
    printErrorStats(args.dipErrorStats, args.output)
    printQVStats(args.dipQVStats, args.output)
