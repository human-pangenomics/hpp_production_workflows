...
class CoverageDistribution:
    ...
    def fit(spectrum, tol = 1e-6, max_iters = 10000):
        ...
        for iteration in range(max_iters):
            ...
            # to avoid over-fitting the extra mode is contrained to be located within a margin
            if new_cov_extra < 0.25 * cov_dist.cov_per_ploidy or new_cov_extra > 0.75 * cov_dist.cov_per_ploidy:
                new_cov_extra = cov_dist.cov_per_ploidy * 0.5
