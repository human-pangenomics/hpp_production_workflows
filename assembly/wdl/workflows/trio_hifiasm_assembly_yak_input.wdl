...
workflow trioHifiasmAssembly {
    ...
    output {
        ...
        File adapterBlastOutTarGz = trioHifiasm.adapterBlastOutTarGz
        File adapterBlockListTarGz = trioHifiasm.adapterBlockListTarGz
        File countReadsTarGz = trioHifiasm.countReadsTarGz
    }
    parameter_meta {
