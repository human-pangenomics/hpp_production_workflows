...
def main(myCommandLine=None):
    ...
    if not read_length:
        print(sys.argv[1:], '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, '\t', 0, file=sys.stdout)
    else:
        ...
        for item in read_length:
            ...
            counter += 1
            if n50 >= target:
                print(sys.argv[1:], '\t', read_length[counter - 1], '\t', total_gigabases, '\t', coverage, '\t', lt100, '\t', lt200, '\t', lt300, '\t', lt400, '\t', lt500, '\t', lt1000, '\t', num1000, file=sys.stdout)
                break
