...
printf "\n############\nHIFI AND ONT\n############\n"
bedtools intersect -a $prefix.hifi.low_high.trim1k.gt10.bed -b $prefix.ont.low_high.trim1k.gt10.bed | bedtools merge -i - | python3 ${BLOCK_STATS_PY}
...
printf "\n########################\nHIFI AND BIONANO\n########################\n"
bedtools intersect -a $prefix.hifi.low_high.trim1k.gt10.bed -b $prefix.bionano.low_high.trim1k.no_censat.gt10.bed | bedtools merge -i - | python3 ${BLOCK_STATS_PY}

printf "\n#######################\nONT AND BIONANO\n#######################\n"
bedtools intersect -a $prefix.ont.low_high.trim1k.gt10.bed -b $prefix.bionano.low_high.trim1k.no_censat.gt10.bed | bedtools merge -i - | python3 ${BLOCK_STATS_PY}

printf "\n#######################\nHiFi and ONT AND BIONANO\n#######################\n"
bedtools intersect -a $prefix.ont.low_high.trim1k.gt10.bed -b $prefix.hifi.low_high.trim1k.gt10.bed | bedtools merge -i - > $prefix.ont_and_hifi.low_high.trim1k.gt10.bed
bedtools intersect -a $prefix.ont_and_hifi.low_high.trim1k.gt10.bed -b $prefix.bionano.low_high.trim1k.no_censat.gt10.bed | bedtools merge -i - | python3 ${BLOCK_STATS_PY}
